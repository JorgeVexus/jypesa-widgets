(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      "  .bp-num{font-size:32px;margin-right:12px;}",
      "  .bp-sep{height:36px;margin-right:12px;}",
      "  .bp-text{max-width:175px;}",
      "  .bp-item-title{font-size:16px;line-height:1.15;}",
      "  .bp-item-desc{font-size:12px;line-height:1.25;margin-top:2px;}",
      "  .bp-soap{height:min(400px,42vh);top:43%;}",
      "  .bp-item.bp-pos-1{left:8%;top:2%;}",
      "  .bp-item.bp-pos-2{left:4%;top:19%;}",
      "  .bp-item.bp-pos-3{left:0.5%;top:36%;}",
      "  .bp-item.bp-pos-4{left:3%;top:54%;}",
      "  .bp-item.bp-pos-5{left:8%;top:71%;}",
      "  .bp-item.bp-pos-6{left:50%;top:85%;transform:translateX(-50%);}",
      "  .bp-item.bp-pos-11{right:8%;top:2%;}",
      "  .bp-item.bp-pos-10{right:4%;top:19%;}",
      "  .bp-item.bp-pos-9{right:0.5%;top:36%;}",
      "  .bp-item.bp-pos-8{right:3%;top:57%;}",
      "  .bp-item.bp-pos-7{right:8%;top:71%;}",
      "}",
      "",
