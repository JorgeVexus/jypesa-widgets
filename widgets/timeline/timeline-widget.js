...
.jypesa-timeline .timeline-item:hover .dot-ring--outer,
.jypesa-timeline .timeline-item.active .dot-ring--outer,
.jypesa-timeline .timeline-item.visited .dot-ring--outer {
  transform: scale(1.15);
  background: rgba(72, 169, 197, 0.35);
}

.jypesa-timeline .timeline-item:hover .dot-ring--inner,
.jypesa-timeline .timeline-item.active .dot-ring--inner,
.jypesa-timeline .timeline-item.visited .dot-ring--inner {
  transform: scale(1.2);
}
...
/* ==========================================================================
   ANIMACIÓN DE ENTRADA ACELERADA (js-animate-entry)
   ========================================================================== */

/* Entrada escalonada acelerada */
...
/* Hover en no visitados/activos */
.jypesa-timeline .timeline-item:not(.active):not(.visited):hover .timeline-year,
.jypesa-timeline .timeline-item:not(.active):not(.visited):hover .timeline-dot,
.jypesa-timeline .timeline-item:not(.active):not(.visited):hover .timeline-body {
