(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      "  height:min(450px,45vh);width:auto;max-width:80%;object-fit:contain;z-index:1;pointer-events:none;",
      ...
      "  .bp-item.bp-pos-6{left:50%;top:84%;transform:translateX(-50%)}",
      ...
      "}",
      "",
      "/* Pantallas medianas / laptops (≤1439px): reducir fuentes y optimizar espaciado vertical */",
      "@media (max-width:1439px) and (min-width:901px){",
      "  .bp-num{font-size:30px;margin-right:10px;}",
      "  .bp-sep{height:34px;margin-right:10px;}",
      "  .bp-text{max-width:165px;}",
      "  .bp-item-title{font-size:15px;line-height:1.15;}",
      "  .bp-item-desc{font-size:11.5px;line-height:1.25;margin-top:2px;}",
      "  .bp-soap{height:min(380px,40vh);top:42%;}",
      "  .bp-item.bp-pos-1{left:8%;top:2%;}",
      "  .bp-item.bp-pos-2{left:4%;top:17%;}",
      "  .bp-item.bp-pos-3{left:0.5%;top:31%;}",
      "  .bp-item.bp-pos-4{left:3%;top:57%;}",
      "  .bp-item.bp-pos-5{left:8%;top:73%;}",
      "  .bp-item.bp-pos-6{left:50%;top:85%;transform:translateX(-50%);}",
      "  .bp-item.bp-pos-11{right:8%;top:2%;}",
      "  .bp-item.bp-pos-10{right:4%;top:17%;}",
      "  .bp-item.bp-pos-9{right:0.5%;top:31%;}",
      "  .bp-item.bp-pos-8{right:3%;top:57%;}",
      "  .bp-item.bp-pos-7{right:8%;top:73%;}",
      "}",
      "",
      ...
      "  .bp-soap{position:static;transform:none;width:auto;max-width:min(200px,60vw);",
      "    height:auto!important;max-height:240px;object-fit:contain;margin:6px auto 18px;display:block;}",
