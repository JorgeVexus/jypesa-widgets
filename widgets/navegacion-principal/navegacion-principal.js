...
<div class="mobile-overlay" id="m-overlay">
  ...
  function setupNavEvents(target, lang) {
    ...
    if (document.currentScript && document.currentScript.src) {
      ...
      const idx = src.indexOf('widgets/navegacion-principal');
      if (idx !== -1) {
      ...
      for (let i = 0; i < scripts.length; i++) {
        ...
        if (src && src.includes('navegacion-principal.js')) {
          const idx = src.indexOf('widgets/navegacion-principal');
          if (idx !== -1) {
            basePath = src.substring(0, idx);
          }
    ...
    const IMAGES = {
      ...
      'Soportes': basePath + 'widgets/navegacion-principal/images/Soportes.webp',
      ...
      'Almond': basePath + 'widgets/navegacion-principal/images/Almond.webp',
      'Botanicus': basePath + 'widgets/navegacion-principal/images/Botanicus.webp',
      'For All Folks': basePath + 'widgets/navegacion-principal/images/For-All-Folks.webp',
      'Vervan': basePath + 'widgets/navegacion-principal/images/Vervan.webp',
      'Rainforest': basePath + 'widgets/navegacion-principal/images/rain%20forest.webp',
    };
